    ...
    <>
      ...
      <div className="flex items-center justify-center text-white h-screen transform -translate-y-24">
        <div className="mr-4 flex flex-col items-center">
          ...
          <button className={styles.button + " mt-4"}>Registrarse</button>
        </div>
     ...
     <div className="text-center text-white mx-auto max-w-5xl transform -translate-y-40">
          <h2 className={styles.text2}>
            Explora perspectivas únicas, comparte tus opiniones e inspírate con las historias de tus compañeros. 
            Juntos, construiremos comunidad de aceptación, empatía y entendimiento que superara los límites del campus, 
            preparándonos para convertirnos en líderes comprometidos con la diversidad en nuestras futuras carreras y comunidades.
          </h2>
      ...
      <div className="text-center text-white transform -translate-y-10">
        <h1 className={styles.jockeyFont}>
          Toda la comunidad de la <span className="text-purple-800"> UP</span> en un <br/>solo lugar
        </h1> 
      </div>


        <div className="flex items-center justify-center ">        <video
              className="rounded-2xl"
              width="1000"
              height="500"
              autoPlay
